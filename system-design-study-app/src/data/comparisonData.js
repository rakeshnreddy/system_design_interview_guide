export const comparisonData = {
  "sql-vs-nosql": {
    title: "{{SQL (Structured Query Language)|SQL}} vs. {{NoSQL (Not Only SQL)|NoSQL}} Databases",
    description: "Comparing relational ({{SQL (Structured Query Language)|SQL}}) and non-relational ({{NoSQL (Not Only SQL)|NoSQL}}) [databases](#/databases) across various characteristics.",
    radarData: [
  ...
  "rest-vs-grpc": {
    title: "{{REST (Representational State Transfer)|REST}} vs. {{gRPC (Google Remote Procedure Call)|gRPC}}",
    description: "Comparing two common {{API (Application Programming Interface)|API}} architectural styles.",
    radarData: [
  ...
  "monolith-vs-microservices": {
    title: "{{Monolithic Architecture|Monolithic}} vs. {{Microservices Architecture|Microservices}} Architecture",
